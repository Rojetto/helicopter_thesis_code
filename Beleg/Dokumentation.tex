...
%	\end{figure}
	...
	\begin{comment}
	Dabei werden die nichtlinearen Systemgleichungen
	...
	\end{comment}
	Das grundsätzliche Vorgehen ist dabei ähnlich wie beim Reglerentwurf in Abschnitt 2.1.2. Im Unterschied dazu, betrachtet man jedoch nicht nur die Dynamik der Zustände, sondern auch die des Systemausgangs.
	\begin{equation}
	\bm y = \bm{g}(\bm{x}, \bm u)
	\end{equation}
	...
	\begin{comment}
	Dies geschah ohne Wissen von dem Paket \textit{symbtools} von Dr.\ Knoll, welches einen anderen Algorithmus zur Rangbestimmung symbolischer Matrizen.
	\end{comment}

...
\begin{tikzpicture}
    ...
    \node [above = 0.3 cm of eps_pid,draw,inner sep = 0.2 cm,xshift=0cm] (vs) {Vorsteuerung};
    ...
    \draw [double] (heli) -- ++(2,0) node [midway,above] {$x$} -- ++(0, -1.8) coordinate (base) -- (sum_lamb |- base);

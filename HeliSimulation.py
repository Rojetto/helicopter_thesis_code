...
class stateLimits(object):
    ...
    def __init__(self):
        ...
        self.p_max = 2/3 * np.pi/2
        self.p_min = -self.p_max
        self.e_max = 2 / 3 * np.pi / 2
        self.e_min = -self.e_max
        self.lamb_max = 2 / 3 * np.pi / 2
        self.lamb_min = -self.lamb_max
        self.eps_p = 0
        self.eps_e = 0
        self.eps_lamb = 0

class HeliSimulationWithLimits(object):
    '''Class for Simulation of the DGL without friction, with limits for system state variables'''
    ...
    def checkLimits(self):
        ...
        self.solver.set_initial_value([p, e, lamb, dp, de, dlamb])
        return

...
L_1 = mc.l_p
L_2 = mc.g * (mc.l_c * mc.m_c - mc.l_h * mc.m_h)
L_3 = mc.l_h
L_4 = mc.l_h

J_p_static = mc.m_h*mc.l_p**2
J_e_static = mc.m_c * mc.l_c**2 + mc.m_h*mc.l_h**2
J_l_static = mc.m_c * mc.l_c**2 + mc.m_h * (mc.l_h**2 + mc.l_p**2)
...
class HeliKalmanSimulation(object):
